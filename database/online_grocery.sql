...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2023 at 07:52 AM
...
(40, 'mango', 'FruitVegetables', 5, 'mango3.jpg', 'healthy for body and tasty.', '200');
...
(3, 'Harshan Naik', '9876543210', 'abcd123@gmail.com', 'Abcd@123'),
(4, 'admin@gmail.com', '08197334965', 'prajnashetty062003@gmail.com', 'password'),
(5, 'PRAJNA SHETTY', '907654345', 'prajna@gmail.com', 'prajna@1234'),
(6, 'hdhsad', '374675454', '21ise022@bnmit.in', '1234'),
(7, 'mahalashm', '9087564534', 'maha123@gmal.com', 'Maha@54');
...
--
ALTER TABLE `cart`
  MODIFY `cartid` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
